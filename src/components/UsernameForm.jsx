...
const UsernameForm = ({ onSubmit, isLoading }) => {
  ...
  return (
    <section id="username-form" className="bg-white py-6">
      <div className="container mx-auto px-4">
        <div className="max-w-full mx-auto text-center">

          <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm min-h-[200px] flex flex-col justify-center">
